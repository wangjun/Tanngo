...
//        Log.d(Utility.LOG_TAG,"ddtTime--->"+defaultDeadlineTime.month+" Month"+ defaultDeadlineTime.monthDay+" Day" );
    ...
    public int getDeadlineYear(){ return sp.getInt(saved_deadline_year,defaultDeadlineTime.year);}
    public int getDeadlineMonth(){ return sp.getInt(saved_deadline_month,defaultDeadlineTime.month);}
    public int getDeadlineDay(){ return sp.getInt(saved_deadline_day,defaultDeadlineTime.monthDay);}
    public String getDictName(){ return sp.getString(saved_dict_name,null);}
